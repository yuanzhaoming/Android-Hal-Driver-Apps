...
int _arg1;
_arg1 = data.readInt();
int _result = this.ledctl(_arg0, _arg1);
...
@Override public int ledctl(int which, int state) throws android.os.RemoteException
{
...
mRemote.transact(Stub.TRANSACTION_ledctl, _data, _reply, 0);
...
static final int TRANSACTION_ledctl = (android.os.IBinder.FIRST_CALL_TRANSACTION + 0);
}
